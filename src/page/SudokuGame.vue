...
const {
  grid, selectedCell, isNoteMode, gameWon, formattedTime,
  initGame, setCellValue, numberCounts
} = useSudoku()
...
const handleKeyDown = (e: KeyboardEvent) => {
  ...
  if (e.key >= '1' && e.key <= '9') {
    ...
    if (e.key === 'ArrowDown') selectedCell.value.row = Math.min(8, row + 1)
    if (e.key === 'ArrowLeft') selectedCell.value.col = Math.max(0, col - 1)
    if (e.key === 'ArrowRight') selectedCell.value.col = Math.min(8, col + 1)
  }
}
    ...
    <div class="page-container">
      ...
      <div v-if="showSetup" class="setup-overlay">
        <div class="setup-card">
          ...
          <div class="difficulty-options">
            ...
            <button class="diff-btn medium highlight" @click="startGame('medium')">
      ...
      <div v-if="gameWon" class="setup-overlay victory">
        <div class="setup-card">
          ...
          <p class="setup-subtitle">You solved the puzzle in {{ formattedTime }}</p>
          <div class="difficulty-options">
            <button class="diff-btn highlight" @click="showSetup = true">
        ...
        <div class="main-layout">
          ...
          <div class="controls-container">
            <div class="top-controls">
              ...
              <button class="control-btn erase" @click="handleInput(null)">
            ...
            <div class="numpad">
              <button 
                ...
                :key="n" 
                class="num-btn"
                :class="{ completed: (numberCounts[n] ?? 0) >= 9 }"
                @click="handleInput(n)"
              >
                {{ n }}
              </button>
...
.diff-btn {
  ...
  .btn-main { font-weight: 800; font-size: 1.2rem; }
...
.timer { font-size: 1.2rem; font-weight: 700; color: #60a5fa; font-variant-numeric: tabular-nums; }
